...
puts how_many_missing([1, 2, 3, 8, 9])# ➞ 4
...
puts how_many_missing([1, 3])# ➞ 1

puts how_many_missing([7, 10, 11, 12])# ➞ 2

puts how_many_missing([1, 3, 5, 7, 9, 11])# ➞ 5

puts how_many_missing([5, 6, 7, 8])# ➞ 0